...
const ModalDeleteEvaluacion = ({ typeResource,resource, onClose, onDeleteSuccess }) => {
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title">Eliminar Evaluacion</h5>
            <button type="button" className="close" onClick={onClose}>
              <span>&times;</span>
            </button>
          </div>
          <div className="modal-body">
            <p>¿Estás seguro de que deseas eliminar esta evaluacion?</p>
          </div>
...
export default ModalDeleteEvaluacion;
